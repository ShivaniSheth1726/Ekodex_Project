  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.breadcrumb}>
        <span style={styles.breadcrumbLink}>Merchant Mapping</span>
        &nbsp;/&nbsp;Configuration&nbsp;/&nbsp;<strong>Merchant Mapping</strong>
      </div>

      {/* Card */}
      <div style={styles.card}>
        <div style={styles.cardTitle}>Merchant Mapping</div>
        ...
        <div style={styles.formGrid}>
          ...
          <div style={styles.formGroup}>
            <label style={styles.label}>MID:</label>
            <input type="text" style={styles.input} />
          </div>
          <div style={styles.formGroup}>
            <label style={styles.label}>Channal:</label>
