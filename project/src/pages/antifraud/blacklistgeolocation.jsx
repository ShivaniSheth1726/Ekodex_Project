...
export default function BlacklistCardMask() {
  ...
  return (
    <div style={containerStyle}>
      {/* Breadcrumbs */}
      <div style={breadcrumbStyle}>Anti-fraud &gt; Groups &gt; Blacklist Geolocation</div>

      {/* Page Title */}
      <div style={headerStyle}>Blacklist Geolocation</div>
          ...
          <div>
            ...
            >
              ...
              <option value="disabled">Disabled</option>
                    ...
                    <div>
            <label style={labelStyle}>Blacklist Group:</label>
            <select
              value={filters.status}
              onChange={(e) =>
                setFilters({ ...filters, status: e.target.value })
