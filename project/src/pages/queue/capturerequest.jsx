...
export default function CaptureRequests() {
  ...
  return (
    <div style={containerStyle}>
      <div style={{ marginBottom: "10px", color: "#64748b" }}>
        Queues &gt; Capture Requests
      </div>
      <button style={exportBtnStyle}>Export</button>
      <div style={cardStyle}>
        <div style={headerStyle}>Capture Requests</div>
        ...
        <div style={formRowStyle}>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setFilters({ ...filters, captureDate: e.target.value })
              }
              style={inputStyle}
            />
          </div>
        ...
        {/* Second Row - 2 fields + span empty */}
        <div style={formRowStyle}>
          <div>
          ...
          <div>
            <label style={labelStyle}>Capture Type:</label>
            <select
